...
import { useRewardCampaignTable } from "@/components/RewardCampaigns/RewardCampaignTable";
...
const RewardCampaignPageContent = () => {
  const {
    campaigns,
    meta,
    page,
    ...
    <>
      ...
      <div className="mb-6 grid gap-4 md:grid-cols-4">
        <CampaignStatCard
          ...
          value={meta?.stats?.total_campaigns || 0}
        />

        <CampaignStatCard
          title="Active"
          value={meta?.stats?.active_campaigns || 0}
        />

        <CampaignStatCard
          title="Inactive"
          value={meta?.stats?.inactive_campaigns || 0}
        />

        <CampaignStatCard
          title="Percentage"
          value={meta?.stats?.percentage_campaigns || 0}
        />
      </div>
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-dark-5 dark:text-dark-6">
              Manage MULA reward campaigns with direct image upload.
            </p>
          </div>
          ...
          <div className="max-h-[90vh] w-full max-w-5xl overflow-y-auto rounded-[10px] bg-white p-6 shadow-1 dark:bg-gray-dark dark:shadow-card">
            <div className="mb-5 flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-dark dark:text-white">
                  {editingCampaign ? "Edit Reward Campaign" : "Add Reward Campaign"}
                </h3>

                <p className="mt-1 text-sm text-dark-5 dark:text-dark-6">
                  Upload reward campaign image directly from your device.
                </p>
              </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <CampaignInput
                ...
                onChange={(value) =>
                  setForm({ ...form, usage_limit: value })
                }
              />
              ...
              <CampaignInput
                ...
                onChange={(value) =>
                  setForm({ ...form, min_order_amount: value })
                }
              />
      ...
      <div className="rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card">
        {isLoading ? (
          <div className="p-6">Loading reward campaigns...</div>
        ) : isError ? (
          <div className="p-6">
            <p className="mb-3 text-red">Failed to load reward campaigns.</p>
  ...
  <tbody>
    {campaigns.map((campaign: RewardCampaign, index: number) => (
      <tr
        key={campaign.id}
      ...
      >
        ...
        <td className="px-6 py-4">
          {campaign.image ? (
            <img
              ...
              alt={campaign.title || "Reward Campaign"}
        ...
        <td className="px-6 py-4 text-sm text-dark-5 dark:text-dark-6">
          {campaign.used_count || 0} / {campaign.usage_limit || "-"}
        </td>
        ...
        <td className="px-6 py-4">
          <div className="flex items-center gap-2">
            <TableActionButton onClick={() => openEditForm(campaign)}>
              Edit
            </TableActionButton>
...
type CampaignStatCardProps = {
  title: string;
  value: string | number;
};

const CampaignStatCard = ({ title, value }: CampaignStatCardProps) => {
  return (
...
export default RewardCampaignPageContent;